...
#[deprecated(
    since = "0.8.0",
    note = "as of STAC v1.1.0, data type has been moved to common metadata in the spec, and is now available at the top level of the crate"
)]
pub use crate::DataType;
#[deprecated(
    since = "0.8.0",
    note = "as of STAC v1.1.0, statistics have been moved to common metadata in the spec, and is now available at the top level of the crate"
)]
...
pub struct Raster {
    ...
    #[deprecated(
        since = "0.8.0",
        note = "v2.0.0 of the raster extension removes the bands array in favor of the common metadata version"
    )]
