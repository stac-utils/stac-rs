...
- `stac convert` and geoparquet support ([#256](https://github.com/stac-utils/stac-rs/pull/256))
...
[Unreleased]: https://github.com/stac-utils/stac-rs/compare/stac-cli-v0.1.0..main
